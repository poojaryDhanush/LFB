...
#define AIN2 5  // Define motor driver pin AIN1 to digital pin 4
#define BIN2 9  // Define motor driver pin BIN1 to digital pin 6
#define AIN1 4  // Define motor driver pin AIN2 to digital pin 2
#define BIN1 8   // Define motor driver pin BIN2 to digital pin 7
#define PWMA 3  // Define motor driver PWM A to digital pin 3
#define PWMB 10
//------------------------------------------------------------

//--------Enter Line Details here---------
bool isBlackLine = 1;             //keep 1 in case of black line. In case of white line change this to 0
unsigned int lineThickness = 23;  //Enter line thickness in mm. Works best for thickness between 10 & 35
